          ...
          public void onClick(View view) {
            ...
            users.addListenerForSingleValueEvent(
                new ValueEventListener() {
                  /**
                   * Creates and adds new user in Firebase if entered information is valid and
                   * username is unique
                   *
                  ...
                  public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (dataSnapshot.child(temp.getUsername()).exists()) {
                      ...
                      Toast.makeText(
                          SignUpActivity.this, "This Username is Taken!", Toast.LENGTH_SHORT)
                          .show();
                    ...
                    // Check to see if username is valid
                      ...
                      Toast.makeText(
                          SignUpActivity.this, "That username is not valid",
                          Toast.LENGTH_SHORT)
                          .show();
                      ...
                      if (editConfirmPassword
                        ...
                        Toast.makeText(
                            SignUpActivity.this, "Registered Successfully!",
                            Toast.LENGTH_SHORT)
                            .show();
